			...
			<div class="large-4 cell">
				<?php if (get_field('top_ten_post')) : ?>
					<div class="pad-full-small">
						<div class="top-ten-slider slick lazy">
							<?php if (have_rows('top_ten')) : ?>
								<?php while (have_rows('top_ten')) : the_row(); ?>
									<div class="slide text-center">
										<?php $product_id = get_sub_field('product'); ?>
										<img class="slick-loading" data-lazy="<?php echo get_the_post_thumbnail_url( $product_id->ID, 'top_ten_slide'); ?>" alt="Photo of <?php echo get_the_title($product_id->ID); ?>">

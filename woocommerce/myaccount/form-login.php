				...
				<div class="pad-full-small white-bg">
					...
					<form class="woocommerce-form woocommerce-form-login login" method="post">
						...
						<p class="form-row">
							...
							<button type="submit" class="expanded button" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>"><?php esc_html_e( 'Login', 'woocommerce' ); ?></button>
						</p>
						...
						<h2 class="text-center h4 margin-bottom-small"><?php esc_html_e( 'Register', 'woocommerce' ); ?></h2>
							...
							<form method="post" class="register">
								...
								<p class="woocommerce-FormRow form-row">
									...
									<button type="submit" class="woocommerce-Button button expanded" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>"><?php esc_html_e( 'Register', 'woocommerce' ); ?></button>
								</p>
